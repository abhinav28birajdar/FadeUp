    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
            <Animated.View style={[styles.content, rStyle]}>
                ...
                <Text style={[Typography.h1, styles.title, { color: Colors.text }]}>Discover Top Barbers</Text>
                <Text style={[Typography.body, styles.description, { color: Colors.textSecondary }]}>
                    Find the best barbers in your city, explore their styles, and see honest reviews from real customers.
                </Text>
            </Animated.View>
